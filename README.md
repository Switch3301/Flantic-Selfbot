# Flantic-Selfbot
This selfbot is being used by some skids and i decided to make one similar to that.This is used to auto solve a flantic challenge text (typeracing) and reaction text
# How to use
